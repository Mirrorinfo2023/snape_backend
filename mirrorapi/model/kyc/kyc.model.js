...
module.exports = (sequelize, DataTypes, Model) => {
  ...
  kyc.init({
    ...
    shop_act_number: { type: DataTypes.STRING, allowNull: true },
    udyog_aadhar_number: { type: DataTypes.STRING, allowNull: true },
    gst_number: { type: DataTypes.STRING, allowNull: true },
    shopActFile: { type: DataTypes.TEXT, allowNull: true },
    udyogAadharFile: { type: DataTypes.TEXT, allowNull: true },
    gstFile: { type: DataTypes.TEXT, allowNull: true },
    moaFile: { type: DataTypes.TEXT, allowNull: true },
    incorporationFile: { type: DataTypes.TEXT, allowNull: true },
