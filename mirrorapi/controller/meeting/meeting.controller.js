...
class Meeting {
    ...
    constructor() {
      ...
      async addMeeting(filename, req, res) {
                let t;
                
                const { meeting_name, meeting_link, description, meeting_date,meeting_time} = req;
                ...
                try {
                  ...
                  const combinedDateTimeStr = `${utility.formatDateNew(meeting_date)} ${meeting_time}`;
                  const meetingDateTime = new Date(combinedDateTimeStr);
