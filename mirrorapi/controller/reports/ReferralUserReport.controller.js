    ...
    try {
      ...
      if (todayBussiness !== null) {
        return res.status(200).json({
          status: 200, message: 'Successful', todayBussiness: todayBussiness, MonthlyPlanBussiness,
      ...
      return res.status(400).json({
        status: 400, message: 'Record not found', todayBussiness: [], MonthlyPlanBussiness: [],
        Silver,
        Gold,
        Platinum,
        Diamond,
      ...
      return res.status(500).json({
        status: 500, message: error, todayBussiness: [], MonthlyPlanBussiness: [],
