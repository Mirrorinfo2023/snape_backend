...
class Passbook {
  ...
  async passbook(req, res) {
    try {
      ...
      console.log("🟢 Extracted Values:", { user_id, page, filter });
      ...
      if (!user_id) {
        ...
        return res.status(400).json({
          status: 400,
          message: "Required input data is missing: user_id",
        });
      }
      ...
      console.log("🟢 Base whereClause:", whereClause);
      ...
      console.log("🟢 Final whereClause After Filter:", whereClause);

      const attributes = [
        'id', 'user_id', 'transaction_id', 'env', 'type', 'sub_type', 'opening_balance',
        'credit', 'debit', 'closing_balance', 'tran_for', 'status', 'transaction_date',
        'created_on', 'created_by', 'modified_on', 'modified_by', 'deleted_on', 'mlm_id',
        'first_name', 'last_name', 'mobile', 'email', 'consumer_number', 'main_amount',
        'recharge_amount', 'recharge_type', 'service_rate', 'service_amount',
        'cashback_amount', 'cashback_rate', 'trax_id', 'message', 'operator',
        'operator_image', 'panel', 'category', 'plan_name', 'plan_amount', 'prime_rate',
        'from_user_fname', 'from_user_lname', 'from_user_mlm_id', 'from_user_mobile',
        'to_user_fname', 'to_user_lname', 'to_user_mlm_id', 'to_user_mobile',
        'reference_no', 'recharge_status'
      ];

      console.log("🟢 Fetching data with pagination... Page:", page);
      ...
      console.log("🔴 ERROR in passbook():", error);
