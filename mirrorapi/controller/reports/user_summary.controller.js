...
class SendMoney {
  ...
  async summary(req, res) {
    ...
    try {
      ...
      const report = {
        total_count: await this.db.userSummary.count('user_id', {
          where: {
            transaction_date: {
              [Op.between]: [fromDate, toDate]
            }
        ...
        total_credit: await this.db.userSummary.sum('credit', {
          where: {
            transaction_date: {
              [Op.between]: [fromDate, toDate]
            }
        ...
        total_debit: await this.db.userSummary.sum('debit', {
          where: {
            transaction_date: {
              [Op.between]: [fromDate, toDate]
            }
        ...
        total_oldbalance: await this.db.userSummary.sum('opening_balance', {
          where: {
            transaction_date: {
              [Op.between]: [fromDate, toDate]
            }
        ...
        total_newbalance: await this.db.userSummary.sum('closing_balance', {
          where: {
            transaction_date: {
              [Op.between]: [fromDate, toDate]
            }
