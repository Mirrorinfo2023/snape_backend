...
otp.post('/get-email-otp', (req, res) => {
	otpController.getEmailOtp(req, res)
});
otp.post('/get-mobile-otp', (req, res) => {
	otpController.getMobileOtp(req, res)

});
otp.post('/verify-email-otp', (req, res) => {
	otpController.VerifyEmailOtp(req, res)
