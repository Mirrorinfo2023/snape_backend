...
insurance.post('/get-insurance-history', (req, res) => {
	...
	insuranceController.getInsuranceDetails(req.body, res);
});

// insurance.post('/7606f026cb85c94187709c98a0ae7bee1ff93979', authenticateJWT, logMiddleware, (req, res) => {

// 	insuranceController.updateInsurance(req.body,res)     
// 	  .catch(error => {
...
// 	insuranceController.getPolicyPdf(req.body,res)     
// 	  .catch(error => {
...
// 	insuranceController.getInsuranceUserDetails(combinedData,res)     
// 	  .catch(error => {
...
// 	insuranceController.getInsuranceUserDetailsReport(req,res)     
// 	  .catch(error => {
...
insurance.post('/get-insurance-report', (req, res) => {
	...
	insuranceController.insurance_data(req.body, res);
});
