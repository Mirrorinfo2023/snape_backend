...
// add-category
affiliateCategories.post('/e8c972c374e0499787cf9a6674ee95ba94e2731f', logMiddleware, async (req, res) => {
	// const fileName = req.file.filename;
	categoriesController.addCategory(req, res)

});
// Update category route
// affiliateCategories.post('/update-affiliate-category', async (req, res) => {
// 	categoriesController.updateCategory(req, res);
// });

// Delete/update status route
affiliateCategories.post('/delete-category', async (req, res) => {
