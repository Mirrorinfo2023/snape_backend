...
affiliate_link.post('/34eff172edba7ecd9a2cae0e601985a4566f5861', logMiddleware, (req, res) => {
	affiliate_linkController.getAffiliateLinksByTitle(req, res)
...
affiliate_link.post('/get-compaigns', async (req, res) => {
	cuelinkController.get_campaigns(req.body, res);
});

affiliate_link.post('/get-affiliatelink', async (req, res) => {
	cuelinkController.get_links(req.body, res);
});

affiliate_link.post('/get-offers', async (req, res) => {
	cuelinkController.get_Offers(req.body, res);
});

affiliate_link.post('/get-compaigns-admin', async (req, res) => {
	cuelinkController.getMyCampagins(req.body, res);
});
...
affiliate_link.post('/update-affiliate-category', (req, res) => {
	affiliateCatgoryController.updateCategory(req, res);
});
...
affiliate_link.post('/add-affiliate-Link', fileUpload, async (req, res) => {
	const fileName = req.file.filename;
	affiliate_linkController.addAffiliateLink(fileName, req, res);
});
...
affiliate_link.post('/get-affiliate-links-Admin', (req, res) => {
	affiliate_linkController.getAffiliateLinksAdmin(req, res);
});
...
affiliate_link.post('/update-affiliate-link', fileUpload, (req, res) => {
	...
	affiliate_linkController.updateAffiliateLink(fileName, req, res);
});
