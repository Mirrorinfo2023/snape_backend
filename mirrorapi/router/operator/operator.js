...
const destinationPath = (req) => {
	const category = req.body.category || 'default';
	return `uploads/operatorlogos/${category}`;
};
...
serviceOperator.post(
	...
	logMiddleware,
	(req, res) => {
		operatorController.addOperator(req, res)
...
serviceOperator.post('/8a6bb5e0bc0e95eec947e2327b2278d137373901', logMiddleware, (req, res) => {
