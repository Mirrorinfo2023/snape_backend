...
BillPayment.post('/454a048ee09f82be251a44b976fadb1bf3f3a4e6', logMiddleware, (req, res) => {
	billPayController.billerInfo(req.body,res)
...
BillPayment.post('/f308eae69c85a45d634afbcc76a5d94609b832dd', logMiddleware, authenticateJWT, (req, res) => {
	billPayController.billFetch(req.body,res)
	    .then(data => res.json(data))
	    .catch(error => {
...
BillPayment.post('/44672b279d2d2f4cf1a9ea3fae4029bfd1674e39', logMiddleware, authenticateJWT, (req, res) => {
	billPayController.billPay(req.body,res)
	    .then(data => res.json(data))
	    .catch(error => {
...
BillPayment.post('/f570e94788c88dc689374a4d3d6ee5db74442b1a', logMiddleware, authenticateJWT, (req, res) => {
