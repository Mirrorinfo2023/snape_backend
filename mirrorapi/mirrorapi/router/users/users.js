...
const destinationPath = 'uploads/kyc';
...
//Upload Kyc
users.post('/550ecdddb5b8b023dda91594810884c12456d0a3',fileUpload, authenticateJWT, logMiddleware, async (req, res) => {
	...
	kycController.uploadKyc(panImage,aadharImage,aadharBackImage,checkbookImage,req.body,res)
	    .then(data => res.json(data))
	    .catch(error => {
            console.error('Error requesting Upload Kyc:', error);
            res.status(500).json({ error: 'Internal Server Error' });
        });
