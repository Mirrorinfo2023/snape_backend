...
module.exports = (sequelize, DataTypes, Model) => {
    ...
    class Affiliate extends Model {
      ...
      static async getAffiliateAmount(user_id) {
    ...
    static async insert_affiliate_wallet(transactionData)
    {
    ...
    Affiliate.init({
      ...
      {
        sequelize, 
        modelName: 'affiliateWallet',
        tableName: 'tbl_affiliate_wallet', // specify table name here
        timestamps: false
      });
