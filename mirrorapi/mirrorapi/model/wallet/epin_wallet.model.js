...
module.exports = (sequelize, DataTypes, Model) => {
    ...
    class ePinWallet extends Model {
    ...
    static async insert_wallet(transactionData)
    {
        ...
        try {
            const newTransaction = await this.create({
                ...
                console.error('Error inserting into the epin wallet:', error.message);
                throw error;
            }
    ...
    ePinWallet.init({
      ...
      {
        sequelize, 
        modelName: 'ePinWallet',
        tableName: 'tbl_epin_wallet', // specify table name here
        timestamps: false
      });
