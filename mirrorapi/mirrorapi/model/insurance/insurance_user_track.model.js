...
module.exports = (sequelize, DataTypes, Model) => {
    ...
    class insuarnce_user_track  extends Model {
    ...
    insuarnce_user_track.init({
      ...
      {
        sequelize, 
        modelName: 'insuarnce_user_track',
        tableName: 'tbl_insuarance_user_track_details', // specify table name here
        timestamps: false
      });
      
      return insuarnce_user_track;
}
